...
r3a = Review.create(user_id: u1.id, nickname: "Anusha", listing_id:  l3.id, body: "I will always grow these from now on. I planted them in late spring, they didn’t do a whole lot during the hottest part of our Arizona summer but Wednesday we’re established they have gone gangbusters.", rating: 5)
r3b = Review.create(user_id: u2.id, nickname: "Rashmi", listing_id:  l3.id, body: "One of the earliest & most vigorous long beans I've grow. The rampant vines climb aggressively, requiring little training. They bear very early; only one other pole variety I've grown (also black seeded) was faster. Very long, thin, light green pods are borne in incredible numbers.", rating: 4)
...
r5a = Review.create(user_id: u1.id, nickname: "Henry", listing_id:  l5.id, body: "My favorite, together with Beurre de Roquencourt variety. Produces later than BdR but keeps going longer. Tastes great raw!", rating: 3)
r5b = Review.create(user_id: u2.id, nickname: "Harray", listing_id:  l5.id, body: "I’m a lazy gardener, but I planted just three seeds - directly, in unfinished compost - and they all came up in 2-3 days. Thrilled. Still just babies, but I’m confident they’ll do fine.", rating: 5)
...
r6a = Review.create(user_id: u1.id, nickname: "Rashmi", listing_id:  l6.id, body: "Just now got around to doing a test run of these Honduran beans, and they are real winners. Smoky flavor reminiscent of black beans but more subtle. Plants are slow to mature, but produce over a fairly long period. T", rating: 3)
r6b = Review.create(user_id: u2.id, nickname: "Maria", listing_id:  l6.id, body: "I am surprised there is no info on if this is a pole or bush bean. I kinda need to know before I order....I guess I will try call and find out....I am guessing they won't know either.", rating: 2)
...
r7a = Review.create(user_id: u1.id, nickname: "Jason", listing_id:  l7.id, body: "This is a beautiful fun plant. It got the best shot it could here in zone 4 with a historically warm summer, even warm nights. The best I could do is about 2 dozen fully matured pods from 2 plants. Only 2 germinated.", rating: 3)
r7b = Review.create(user_id: u2.id, nickname: "Aaysha", listing_id:  l7.id, body: "I grew these for the first time in 2021. They do grow very high. Easily would go to 8’. They produced well despite the odd weather and fall storms.", rating: 4)
...
r8a = Review.create(user_id: u1.id, nickname:"Anusha", listing_id:  l8.id, body: "This was a fun growing experience. I transplanted one of my successful seeds into a 15 gallon pot that I had put a semi-circle fence trellis in as well and the plant completely engulfed it! The flowers are super delicate, but I did get enough fruit to experiment with, in the kitchen.", rating: 5)
r8b = Review.create(user_id: u2.id, nickname: "Cotton", listing_id:  l8.id, body: "I grew the Big Top bitter melon last year and every seed grew and thrived. However, I ended up losing every plant to hail. 2018 was a nasty year for hail, but these little plants gave me hope that I really can succeed with bitter melon and I will try again in 2019. I feel like if we hadn't of gotten so much hail, these would have been great.", rating: 4)
...
r9a = Review.create(user_id: u1.id, nickname: "Sarah", listing_id:  l9.id, body: "This is so easy to grow. I sowed it directly on the ground and it sprouted within 10 days. I’ve harvested a few fruits with few more on the way. The fruit is a little smaller than the regular green bitter melon, but with less bitter taste. Overall great plant! Easy to care for.", rating: 5)
r9b = Review.create(user_id: u2.id, nickname: "Mimi", listing_id:  l9.id, body: "Very pretty white fruit that's both juicy and scantly bitter. It's easy to grow, pest free and the leaves are very fragrant. I used the leaves to make tea.", rating: 4)
...
r11a = Review.create(user_id: u1.id, nickname: "Anu", listing_id:  l11.id, body: "This did well for us as a winter crop, started indoors in August and set out in late September. (An earlier planting was set out a month earlier and was hurt by 113 degree Santa Ana winds - it survived, but was never as nice.)", rating: 3)
r12b = Review.create(user_id: u2.id, nickname: "Sam", listing_id:  l11.id, body: "I hereby echo one of the reviewers from Minnesota. I had very similar experience . the plants grew well, and I was hoping for the plant to make a decent size head, but the plants was grew to become a long stem and large leaves, the heads we harvested from all the plants were small. I ended up feeding the leaves to my canaries and chicken.", rating: 2)
...
r14a = Review.create(user_id: u1.id, nickname: "Geeta", listing_id:  l14.id, body: "I've been growing this for a few years here, and it's always the sharpest looking plant. Works great as an accent in flower pots", rating: 5)
...
r15a = Review.create(user_id: u1.id, nickname: "Nicola", listing_id:  l15.id, body: "This cabbage was easy and fast growing as a winter crop in central FL. No trouble with disease, and only minor damage from loopers.", rating: 5)
r15b = Review.create(user_id: u2.id, nickname: "Carol", listing_id:  l15.id, body: "I grew this variety for the first time this spring and I am truly impressed. the taste and firmness outshines the regular cannonball cabbage grown in the fall. I would like to grow this type all year long.", rating: 5)
...
r16a = Review.create(user_id: u5.id, nickname: "Soriano", listing_id:  l16.id, body: "Easy to grow and resilient to crazy spring weather. The color fluctuates from light yellow to almost orange. Good flavor and size. I’ll definitely grow again, thanks for the free seeds!", rating: 4)
r16b = Review.create(user_id: u6.id, nickname: "Tuladhar", listing_id:  l16.id, body: "I mixed these with cosmic purple and nantes for variety. I planted the mix in September in Florida. Of all the carrots, they underperformed....HOWEVER when I planted the mix again in the spring, Amarillo WAY outperformed the other types and in fact some of the others didnt even sprout, leading to a bed of mostly Amarillo", rating: 4)
...
r17a = Review.create(user_id: u3.id, nickname: "Anne", listing_id:  l17.id, body: "I'm often struggling with growing carrots, but these always come up perfectly. The taste is wonderful. Until I learn to grow other species better, this is definitely my favorite carrot to grow.", rating: 5)
r17b = Review.create(user_id: u4.id, nickname: "Rashmi", listing_id:  l17.id, body: "I'm dismal when it comes to growing carrots, as in maybe one or two would sprout. Maybe I planted too early or too late for our grow season? I don't know. So I planted these as a lark in the early spring in part of the beet bed and, frankly, kind of forgot about them.", rating: 5)
...
r18a = Review.create(user_id: u1.id, nickname: "Henry", listing_id:  l18.id, body: "One of the coolest cauliflower I've grown, as well as best tasting. Only down side is it had very low germ. but it was labeled as such so no complaints. A farmers market favorite.", rating: 5)
...
r19a = Review.create(user_id: u5.id, nickname: "Gita", listing_id:  l19.id, body: "I loved growing this cauliflower! Super heat tolerant and easy to grow! Grew huge heads probably 12” across! Highly recommend. I forgot to tie the leaves around them so they are tinted yellow but still tastes great!", rating: 5)
...
r22a = Review.create(user_id: u7.id, nickname: "Geeta", listing_id:  l22.id, body: "The first of my four eggplant varieties to produce, and seems like it'll be the last to quit. Incredibly creamy and mild - not the choice for people who want very strong eggplant flavor, but perfect for cooking whole or halved with little to no seasoning. Small fruit, but they're very dense!", rating: 5)
r22b = Review.create(user_id: u8.id, nickname: "Anu", listing_id:  l22.id, body: "I normally use 'Casper' as my white eggplant, but this year I decided to try something new. I'm glad I did. It took the seeds ~one month to germinate @ 80F and started out so slow, I only lost one seedling, but the germination was 95%. Once it was warm enought to plant out, they just took off running and I'm harvesting a few pounds a week out of 8 plants.", rating: 4)
...
r23a = Review.create(user_id: u1.id, nickname: "Jason", listing_id:  l23.id, body: "This radish grows great and early. Nearly perfect germination success rates. Delicious, I even used the greens for some homemade pesto.", rating: 5)
...
r25a = Review.create(user_id: u3.id, nickname: "Cottie", listing_id:  l25.id, body: "These couldn’t be any easier to grow. I planted a bunch of seeds in a milk jug and transplanted them into a raised bed. The plants are well-over a foot tall now with loads of red flowers. They are extremely heat tolerant.", rating: 5)
...
r27a = Review.create(user_id: u8.id, nickname: "Sanumanche", listing_id:  l27.id, body: "Started seeds indoors before last frost. These marigolds were the first to bloom, and are so striking to see, I have to stop and admire them whenever I pass by!", rating: 5)
r27b = Review.create(user_id: u9.id, nickname: "Katherine", listing_id:  l27.id, body: "I started the seeds indoors and transplanted when they were approximately 6-8” tall. They were ridiculous! I don’t want to sound like I am exaggerating, so I will just say 18”, most grew to as high as 18-24”. Planted throughout the garden. Did not have much of a pest problem this year.", rating: 5)
...
r29a = Review.create(user_id: u7.id, nickname: "Tolken", listing_id: l29.id, body: "(T. linneaus) A smoldering and memorable marigold with gracefully wavy stems, and smoky orange and red blooms that resemble embers in a crackling fire. This old variety has long been tended at the Linneas Botantical Gardens in Uppsala, Sweden.", rating: 5)
...
r30a = Review.create(user_id: u4.id, nickname: "Jay", listing_id:  l25.id, body: "First time with marigolds. Tried growing these last year (failed), and decided to keep them indoors under the grow light a little longer this year. Success! I guess I thought these topped out at 2 feet tall; my biggest one is topping at about 26 inches in early Sept.", rating: 3)
...
r32a = Review.create(user_id: u3.id, nickname: "Kat", listing_id:  l32.id, body: "Great germination. The April planted bunch bolted into summer and I let it go as pollinators were enjoying. By September the bolted plants had reseeded for fall. Lots of happy mustards now (October 20) as the weather cools. I live on the edge of a wooded area and have issues with slugs. They have left the mustard alone as the flavor seems to be too strong.", rating: 5)
...
r33 = Review.create(user_id: u5.id, nickname: "Tiffany", listing_id:  l25.id, body: "I grew this around mid-February and had no problems at all. It grew fast and the flavor was amazing of mild wasabi and crispy texture. Also the aphids left it alone and went for the Swiss Chard right next to them.", rating: 5)
r33 = Review.create(user_id: u5.id, nickname: "Ross", listing_id:  l25.id, body: "I planted 3 mustards simultaneously during the coolest time of year here in the highland tropics. This being the tropics pretty much all greens are at a disadvantage. I planted this one and the Japanese Giant Red from Baker Creek, plus Dragon's Tongue from another seller. Of the three, this one was the poorest performer. ", rating: 3)
